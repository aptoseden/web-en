...
export default {
  ...
  methods: {
    ...
    getDictList: function () {
      ...
      this.$http.get('./static/json/getListByDictTypeList.json').then((response) => {
					  if (response.data.data.code == this.$ECode.SUCCESS) {
					      var dictMap = response.data.data.data
      ...
      //     var dictMap = response.data.data;
      //     this.userTagDictList = dictMap.sys_user_tag.list
      //     this.setUserTag(dictMap.sys_user_tag.list)
      //   }
      // });
