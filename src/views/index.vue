        ...
        <div class="bloginfo">
          <ul>
            ...
            <li class="author">
              ...
              <a href="" @click="goToAuthor(item.author)">{{item.author}}</a>
            </li>
...
export default {
  ...
  created () {
    ...
    this.$http.get('./static/json/getBlogByLevel.json').then((response) => {
  ...
  methods: {
    ...
    newBlogList () {
	  ...
	  this.$http.get('./static/json/getNewBlog.json').then((response) => {
        if (response.data.code == this.$ECode.SUCCESS) {
